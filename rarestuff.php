...
<h1> This Page Has stuff that are normally very hard to find. <br> </h1>
<h2> like: <br>
...
* Note: Your anti virus might say dll injector injector is a virus, it isnt, it's just a false positive.<br>
<br>
** Note: (Warning) Graphictoria is a virus, and can kill your antiviruses and stuff. (i just wanted to archive it)<br>
use it in a vm and with a vpn.<br>
that's all for now, maybe there will be more later.<br>
